...
export const STEP_OPTION_IMAGES: StepOptionImage[] = [
  ...
  { image_url: "/media/terracedbrick.png", options: [OPTION_IDS.HOUSE.TERRACED, OPTION_IDS.SURFACE.BRICK] },
  { image_url: "/media/terracedblock.png", options: [OPTION_IDS.HOUSE.TERRACED, OPTION_IDS.SURFACE.BLOCK] },
  { image_url: "/media/terraceedicf.png", options: [OPTION_IDS.HOUSE.TERRACED, OPTION_IDS.SURFACE.ICF] },
  { image_url: "/media/terracedstone.png", options: [OPTION_IDS.HOUSE.TERRACED, OPTION_IDS.SURFACE.STONE] },
  { image_url: "/media/terracedpaintedbrick.png", options: [OPTION_IDS.HOUSE.TERRACED, OPTION_IDS.SURFACE.PAINTED_BRICK] },
  { image_url: "/media/terracedpebbledash.png", options: [OPTION_IDS.HOUSE.TERRACED, OPTION_IDS.SURFACE.PEBBLEDASH] },
  { image_url: "/media/terracedsandandcementrender.png", options: [OPTION_IDS.HOUSE.TERRACED, OPTION_IDS.SURFACE.SAND_CEMENT] },
  { image_url: "/media/terracedrendercarrierboard.png", options: [OPTION_IDS.HOUSE.TERRACED, OPTION_IDS.SURFACE.RENDER_CARRIER] },
  
  // Surface materials - SEMI-DETACHED
  { image_url: "/media/semidetachedbrick.png", options: [OPTION_IDS.HOUSE.SEMI_DETACHED, OPTION_IDS.SURFACE.BRICK] },
  { image_url: "/media/semidetachedicf.png", options: [OPTION_IDS.HOUSE.SEMI_DETACHED, OPTION_IDS.SURFACE.ICF] },
  { image_url: "/media/semidetachedstone.png", options: [OPTION_IDS.HOUSE.SEMI_DETACHED, OPTION_IDS.SURFACE.STONE] },
  { image_url: "/media/semidetachedpaintedbrick.png", options: [OPTION_IDS.HOUSE.SEMI_DETACHED, OPTION_IDS.SURFACE.PAINTED_BRICK] },
  { image_url: "/media/semidetachedblock.png", options: [OPTION_IDS.HOUSE.SEMI_DETACHED, OPTION_IDS.SURFACE.BLOCK] },
  { image_url: "/media/semidetachedpebbledash.png", options: [OPTION_IDS.HOUSE.SEMI_DETACHED, OPTION_IDS.SURFACE.PEBBLEDASH] },
  { image_url: "/media/semidetachedrendercarrierboard.png", options: [OPTION_IDS.HOUSE.SEMI_DETACHED, OPTION_IDS.SURFACE.RENDER_CARRIER] },
  { image_url: "/media/semidetachedsandandcement.png", options: [OPTION_IDS.HOUSE.SEMI_DETACHED, OPTION_IDS.SURFACE.SAND_CEMENT] },
