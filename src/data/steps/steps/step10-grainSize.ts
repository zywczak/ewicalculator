...
export const STEP_10_GRAIN: FormStep = {
    ...
    { id: OPTION_IDS.GRAINSIZE["1MM"], option_value: "1 mm", json_value: 1, image: "/media/texture_1mm.png", parent_option_id: [OPTION_IDS.RENDER_TYPE.NANO_DREX, OPTION_IDS.RENDER_TYPE.PREMIUM_BIO, OPTION_IDS.RENDER_TYPE.SILICONE] },
